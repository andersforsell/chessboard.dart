...
class CoreLocalStorage extends PolymerElement with ChangeNotifier  {
  /**
   ...
   * @default false
   */
  @reflectable @observable bool get useRaw => __$useRaw; bool __$useRaw = false; @reflectable set useRaw(bool value) { __$useRaw = notifyPropertyChange(#useRaw, __$useRaw, value); }
   ...
   * @default false
   */
  @reflectable @observable bool get autoSaveDisabled => __$autoSaveDisabled; bool __$autoSaveDisabled = false; @reflectable set autoSaveDisabled(bool value) { __$autoSaveDisabled = notifyPropertyChange(#autoSaveDisabled, __$autoSaveDisabled, value); }
