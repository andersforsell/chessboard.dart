...
class ChessBoard extends PolymerElement with ChangeNotifier  {
  @reflectable @published String get position => __$position; String __$position = Chess.DEFAULT_POSITION; @reflectable set position(String value) { __$position = notifyPropertyChange(#position, __$position, value); }

  @reflectable @published bool get reversed => __$reversed; bool __$reversed = false; @reflectable set reversed(bool value) { __$reversed = notifyPropertyChange(#reversed, __$reversed, value); }

  @reflectable @published bool get showNotation => __$showNotation; bool __$showNotation = true; @reflectable set showNotation(bool value) { __$showNotation = notifyPropertyChange(#showNotation, __$showNotation, value); }

  @reflectable @published String get pieceTheme => __$pieceTheme; String __$pieceTheme = 'packages/chessboard/img/{piece}.png'; @reflectable set pieceTheme(String value) { __$pieceTheme = notifyPropertyChange(#pieceTheme, __$pieceTheme, value); }

  @reflectable @observable String get gameStatus => __$gameStatus; String __$gameStatus = ''; @reflectable set gameStatus(String value) { __$gameStatus = notifyPropertyChange(#gameStatus, __$gameStatus, value); }

  @reflectable @observable String get turn => __$turn; String __$turn; @reflectable set turn(String value) { __$turn = notifyPropertyChange(#turn, __$turn, value); }

  @reflectable @observable List<String> get pgn => __$pgn; List<String> __$pgn; @reflectable set pgn(List<String> value) { __$pgn = notifyPropertyChange(#pgn, __$pgn, value); }

  @reflectable @observable int get squareSize => __$squareSize; int __$squareSize = 0; @reflectable set squareSize(int value) { __$squareSize = notifyPropertyChange(#squareSize, __$squareSize, value); }
